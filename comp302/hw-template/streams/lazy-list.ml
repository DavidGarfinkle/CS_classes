...
*)
let rec append s1 s2 = raise TODO 

(* ---------------------------------------------------- *)
(* Q4. 3 *)
(* val interleave : int -> int list -> int list lazy_list *)
let rec interleave (x:int) (l:int list) = raise TODO 

(* ---------------------------------------------------- *)
(* Q4. 4 *)
(* val flatten : 'a lazy_list lazy_list -> 'a lazy_list
*)
let rec flatten s = raise TODO 
